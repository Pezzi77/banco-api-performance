...
🔗 Repositório: [github.com/Pezzi77/banco-api-performance](https://github.com/Pezzi77/banco-api-performance)
...
```bash
git clone https://github.com/Pezzi77/banco-api-performance
